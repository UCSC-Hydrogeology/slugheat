%%% =======================================================================
%%  Purpose: 
%       This function resets the axes and all plotting information prior to 
%       reading in a penetration file. All metadata is removed and 
%       measurements are set to zero. Default parameters remain those read 
%       in from the default .par file. 
%%  Last edit:
