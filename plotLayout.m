%%% ====================================================================
%%  Purpose: 
%       This function turns visibility of plots on and off 
%       depending on if their axes are turned off or on with the use of 
%       plot control checkboxes in the SlugHeat command window.
%       There are two smaller functions nested within this function:
