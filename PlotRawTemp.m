%%% =======================================================================
%%   Purpose: 
%       This function plots the inital raw data from the penetration and 
%       tap files before any other processing has been done, except 
%       correcting temperature of each thermistor with reference to bottom
%       water. These plots are found under the Penetration Data tab on 
%       SlugHeat GUI.
%%   Last edit:
