...
%       by that sensor are plotted on the Temperature relative to bottom
%       water vs. record number plot. When a sensor's checkbox is 'off', 
%       the data recorded by that sensor is hidden on the plot. This only 
%       controls the DISPLAY of the data. Must push the Remove Sensors 
%       button totur actually process without the data recorded by this sensor.
%%  Last edit:
